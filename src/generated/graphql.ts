...
export type GrowthGraphStandardDataResponseResolvers<ContextType = AuthContext, ParentType extends ResolversParentTypes['GrowthGraphStandardDataResponse'] = ResolversParentTypes['GrowthGraphStandardDataResponse']> = ResolversObject<{
  ...
  standardData?: Resolver<Array<ResolversTypes['SingleMonthGrowthData']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type GrowthInterpretationResponseResolvers<ContextType = AuthContext, ParentType extends ResolversParentTypes['GrowthInterpretationResponse'] = ResolversParentTypes['GrowthInterpretationResponse']> = ResolversObject<{
  differenceSincePrevious?: Resolver<Maybe<ResolversTypes['Float']>, ParentType, ContextType>;
  isEnough?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
  label?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  severity?: Resolver<ResolversTypes['GrowthInterpretationSeverity'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;
...
export type QueryResolvers<ContextType = AuthContext, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = ResolversObject<{
  growthGraphStandardData: Resolver<Maybe<ResolversTypes['GrowthGraphStandardDataResponse']>, ParentType, ContextType, RequireFields<Query_GrowthGraphStandardDataArgs, 'growthType' | 'recordId'>>;
  growthInterpretation: Resolver<Maybe<ResolversTypes['GrowthInterpretationResponse']>, ParentType, ContextType, RequireFields<Query_GrowthInterpretationArgs, 'growthType' | 'recordId'>>;
}>;

export type SingleMonthGrowthDataResolvers<ContextType = AuthContext, ParentType extends ResolversParentTypes['SingleMonthGrowthData'] = ResolversParentTypes['SingleMonthGrowthData']> = ResolversObject<{
